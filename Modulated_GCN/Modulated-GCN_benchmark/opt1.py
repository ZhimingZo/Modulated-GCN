...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--module_gcn_reload', type=int, default=0, help='if continue from last time')
        ...
        self.parser.add_argument('--module_gcn_model', type=str, default='model_module_gcn_7_eva_post_4939.pth', help='model name')
        ...
        self.parser.add_argument('-previous_module_gcn_name', type=str, default='', help='save last saved model name')
